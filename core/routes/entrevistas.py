...
from core.handlers import entrevistas_handlers as h
...
RULES = [
    ...
    ('/entrevistas/pdf/<int:entrevista_id>', 'generar_pdf_entrevista_db', pdf_h.generar_pdf_entrevista_db, ['GET']),
    ('/generar_pdf_entrevista', 'generar_pdf_entrevista', pdf_h.generar_pdf_entrevista, ['GET']),
    ('/entrevistas/pdf_nuevo/<int:entrevista_id>', 'generar_pdf_entrevista_nueva_db', pdf_h.generar_pdf_entrevista_nueva_db, ['GET']),
    ('/entrevistas/candidata/<int:fila>/pdf', 'generar_pdf_ultima_entrevista_candidata', pdf_h.generar_pdf_ultima_entrevista_candidata, ['GET']),
]
