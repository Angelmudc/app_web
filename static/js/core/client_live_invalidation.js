(function () {
  ...
  const POLL_MS_CONNECTED = Math.max(500, Number(window.__CLIENT_LIVE_POLL_CONNECTED_MS || 2500) || 2500);
  const POLL_MS_FALLBACK = Math.max(500, Number(window.__CLIENT_LIVE_POLL_FALLBACK_MS || 2500) || 2500);
