...
_EXPLICIT_LABELS = {
    ...
    "fuerte": "Fortalezas",
    "razon_trabajo": "Porque eliges trabajar como domestica?",
    "labores_anteriores": "Experiencia y trabajos anteriores",
    "tiempo_ultimo_trabajo": "Tiempo en el último trabajo",
    "razon_salida": "Porque elegiste salir de tu ultimo trabajo",
    "situacion_dificil": "¿Ha tenido situaciones difíciles en trabajos anteriores?",
    "manejo_situacion": "¿Cómo manejó la situación?",
    "manejo_reclamo": "¿Cómo manejaria reclamos o malos tratos?",
    "uniforme": "Esta de acuerdo con usar uniforme?",
    "dias_feriados": "Disponibilidad en días feriados",
    "revision_salida": "Estas de acuerdo con ser revisada en la salida?",
    "colaboracion": "Trabajo en equipo y colaboración",
    "tipo_familia": "Tipo de familia en la que has trabajado",
    "cuidado_ninos": "Ha cuidado niños?",
    "sabes_cocinar": "¿Sabe cocinar?",
    "gusta_cocinar": "¿Le gusta cocinar?",
    "que_cocinas": "¿Qué sabes cocina?",
    "postres": "¿Sabe hacer postres y cuales?",
    "tareas_casa": "¿Cuáles tareas del hogar le gustan?",
    "electrodomesticos": "¿Sabe usar electrodomésticos modernos?",
    "planchar": "¿Sabe planchar?",
    "actividad_principal": "Actividad principal",
    "nivel_academico": "Nivel académico",
    "condiciones_salud": "Tienes alguna condicion de salud?",
    "alergico": "Alergias",
    "medicamentos": "¿Toma algún medicamento?",
    "seguro_medico": "Tienes seguro médico?",
    "pruebas_medicas": "Estas deacuerdo con hacerte pruebas médicas?",
    "vacunas_covid": "Tienes vacunas COVID",
